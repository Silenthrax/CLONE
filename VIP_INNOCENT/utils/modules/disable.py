...
from VIP_INNOCENT import dispatcher
from VIP_INNOCENT.utils.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
...
if is_module_loaded(FILENAME):
    ...
    from VIP_INNOCENT.utils.modules.sql import disable_sql as sql
